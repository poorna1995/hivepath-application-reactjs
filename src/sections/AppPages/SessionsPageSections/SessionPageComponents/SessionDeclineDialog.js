...
import { setDeclineSessionReason } from "store/knowledge-sessions/knowledgeSessionsSlice";

const optionsData = [
  "The attendee doesn't qualify for the prerequisites.",
  "I have decided on another attendee for this slot.",
  "I'd be busy/unavailable in the mentioned time slot.",
  "Other",
];

const SessionDeclineDialog = ({ open, handleClose, onClick }) => {
  ...
  const handleSelectedOption = (e) => {
    ...
    if (e.target.value !== "Other") {
      return dispatch(setDeclineSessionReason(e.target.value));
    }
  };
  ...
  const handleOtherReason = (e) => {
    ...
    dispatch(setDeclineSessionReason(e.target.value));
  };
  return (
...
export default SessionDeclineDialog;
