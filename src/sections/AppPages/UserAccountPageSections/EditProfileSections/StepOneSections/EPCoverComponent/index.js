...
import EPCoverCategories from "./EPCoverCategories";
import EPCoverImages from "./EPCoverImages";
import PrimaryButton from "components/Common/Buttons/PrimaryButton";
import OutlinedButton from "components/Common/Buttons/OutlinedButton";
import EPUploadComponent from "./EPUploadComponent";
  ...
  return (
    ...
    >
      ...
      <TabPanel value={value} index={0}>
        {!showPicks && (
          <EPCoverCategories data={data} onCategoryChange={showPicksHandler} />
        )}
...
export default EPCoverComponent;
