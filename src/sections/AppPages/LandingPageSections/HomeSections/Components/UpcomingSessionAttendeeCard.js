import cardBg from "assets/images/landing-page/attendee-card-bg.png";
...
const UpcomingSessionAttendeeCard = ({ data, ...props }) => {
  const { from, to, date, session_data, host_data } = data;
  const { company, first_name, last_name, image_url, role } = host_data;
  ...
  return (
    <Paper className={classes.attendeeCard}>
      ...
      <Grid
        ...
        spacing={2}
        mt={1}
        className={classes.attendeeCardContent}
        style={{ width: "100%" }}
      >
        <Grid item xs={3} md={3}>
...
UpcomingSessionAttendeeCard.propTypes = {};

export default UpcomingSessionAttendeeCard;
