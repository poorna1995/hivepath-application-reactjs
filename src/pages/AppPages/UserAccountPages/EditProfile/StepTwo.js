...
import EducationDetailsSection from "sections/AppPages/UserAccountPageSections/EditProfileSections/StepTwoSections/";
import {
  addUserProfile,
  updateUserProfile,
  fetchUserProfile,
    ...
    if (updateId) {
      ...
      const res = await updateUserProfile(data).then((response) => {
        ...
        if (!error) {
          ...
          enqueueSnackbar("Successfully added education", {
            variant: "success",
          });
          return true;
        } else {
        ...
        <Grid container spacing={2}>
          <Grid item xs={12} md={8} pb={1}>
            <EducationDetailsSection
              ...
              showFormHandler={setShowEducationForm}
